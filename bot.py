...
@app.on_message(filters.photo & ((lambda filter, message: message.media.mime_type.startswith("image/jpeg") or message.media.mime_type.startswith("image/jpg")) | (lambda filter, message: message.document.mime_type.startswith("image/jpeg") or message.document.mime_type.startswith("image/jpg")))
