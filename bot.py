...
url_pattern = r"https?://(?:www\.)?(?:youtube\.com/watch\?v=|youtu\.be/|youtube\.com/v/)([a-zA-Z0-9_-]+)"
...
async def handle_upload(client, message):
    ...
    try:
        ...
        await message.reply("Invalid URL or no content found. Please provide a valid YouTube URL.")
...
async def callback_handler(client, query):
    ...
    try:
        ...
        await query.answer("Invalid URL or no content found. Please provide a valid YouTube URL.")
